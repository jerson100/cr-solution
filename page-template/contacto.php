...
<div class="bg-white-150 pt-20 pb-14">
    <div class="container">
        <div class="grid grid-cols-2 gap-16">
            <div>
                <p class="font-gordita-regular text-25 text-text-primary mb-10">Si deseas más información sobre nuestros
                ...
                <ul class="flex flex-col gap-6 max-w-[360px] mb-10">
                    ...
                    <li class="flex gap-4 items-center">
                        ...
                        <span class="text-celeste-100 text-25 font-gordita-regular">APV. Agua Buena J-7, San Sebastián,
                            Cusco.</span>
                    </li>
                </ul>
