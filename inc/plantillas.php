<?php
// Creamos la función para el post type plantilla
function custom_post_plantilla() {
    // Registramos la función 'plantilla' según el codex de WP
    register_post_type( 'plantilla',
    // (http://codex.wordpress.org/Function_Reference/register_post_type)
      // Agregamos todas funciones adicionales para el post type plantilla
      array( 'labels' => array(
        'name' => __( 'Plantillas', 'andres-dev' ), /* El título del grupo */
        'singular_name' => __( 'plantilla', 'andres-dev' ), /* El título en singular */
        'all_items' => __( 'Todos los plantillas', 'andres-dev' ), /* Todos los items del menú */
        'add_new' => __( 'Agregar nuevo', 'andres-dev' ), /* Agregar uno nuevo */
        'add_new_item' => __( 'Agregar nuevo plantilla', 'andres-dev' ), /* Agregar nuevo con título */
        'edit' => __( 'Editar', 'andres-dev' ), /* Editar */
        'edit_item' => __( 'Editar plantilla', 'andres-dev' ), /* Editar item */
        'new_item' => __( 'Nuevo plantilla', 'andres-dev' ), /* Nuevo titulo en visualización */
        'view_item' => __( 'Ver plantilla', 'andres-dev' ), /* Ver item */
        'search_items' => __( 'Buscar plantilla', 'andres-dev' ), /* Buscar item */
        ...
        'description' => __( 'Esto es un ejemplo de post type para plantillas', 'andres-dev' ), /* Custom Type Description */
        'public' => true,
        ...
        'menu_icon' => 'dashicons-media-document', /* El icono para el menu de admin */
        // Lo podemos agregar por medio de url o desde https://developer.wordpress.org/resource/dashicons
        'rewrite' => array( 'slug' => 'plantilla', 'with_front' => false ), /* Se especifica el slug de la url, por lo general es el mismo post type 'plantilla' */
        'has_archive' => 'plantilla', /* Puede cambiar el nombre del slug */
        'capability_type' => 'post',
        'hierarchical' => false,
        /* Habilitamos ciertos parámetros para el editor de cada plantilla */
        'supports' => array( 'title', 'editor', 'author', 'thumbnail', 'excerpt', 'trackbacks', 'custom-fields', 'comments', 'revisions', 'sticky')
        ) /* Fin de las opciones */
      ); /* Fin del registro post type */
}
    // Agregando la función al init de WordPress
    add_action( 'init', 'custom_post_plantilla');

// Creamos la taxonomía plantillasgenero para plantillas
add_action( 'init', 'crear_plantilla_taxonomy' );
function crear_plantilla_taxonomy() {
  register_taxonomy(
    'plantillasgenero', // Nombre de la taxonomía
    'plantilla', // Nombre del post type que se le asignará
    array(
      'label' => __( 'Plantillas Categoría' ),
      'rewrite' => array( 'slug' => 'plantillasgenero' ),
      'hierarchical' => true,
    )
  );
}
...
// Creamos taxonomía tags para plantillas
add_action( 'init', 'crear_plantilla_taxonomy_tags' );
function crear_plantilla_taxonomy_tags() {
  register_taxonomy(
    'tag_plantilla', // Nombre de la taxonomía
    'plantilla', // Nombre del post type que se le asignará
    array(
      'rewrite' => array( 'slug' => 'tag_plantilla' ),
      'hierarchical' => false,
...
register_taxonomy( 'plantillasgenero', 
array('plantilla'), /* Agregue el post type al cual le asignara la taxonomía */
...
register_taxonomy( 'tags_plantilla', 
array('plantilla'), /* Agregue el post type al cual le asignara la taxonomía */
array('hierarchical' => false,    /* Si es true actua como categoria - si es false como etiqueta */
  'labels' => array(
    'name' => __( 'Tags plantillas', 'andres-dev' ), /* Nombre de la taxonomía */
...
// /* Registra soporte para categorías al post type plantilla */
register_taxonomy_for_object_type( 'category', 'plantilla' );
// /* Registrar soporte para tags al post type plantilla */
register_taxonomy_for_object_type( 'post_tag', 'plantilla' );
