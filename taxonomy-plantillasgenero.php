...
<div class="screen-top relative">
    <img src="<?php echo IMG; ?>/Plantillas/Banners-2.jpg" class="w-full h-full object-cover absolute left-0 top-0 z-[1] object-right" />
    <div class="containerc">
        <div class="laptop:max-w-[85%] w-full min-h-[160px] py-4 tablet:min-h-[200px] laptop:min-h-[230px] desktop-large:min-h-[264px] laptop:py-12 flex items-center justify-start">
            ...
            <ul class="grid grid-cols-1 tablet-middle:grid-cols-2 laptop:grid-cols-3 gap-8 laptop:gap-10">
                ...
                <?php while (have_posts()) : the_post(); ?>
                    <li data-category="" class="rounded-lg bg-[#313131] flex flex-col">
                        ...
                        <div class="flex justify-between items-center gap-4 shadow-custom px-4 py-3 desktop-middle:px-8 desktop-middle:py-4 rounded-lg bg-white-150 flex-grow">
                                        ...
                                        <div class="modal__body px-4 py-4 laptop:px-8 laptop:py-8 desktop-middle:px-14 desktop-middle:py-14 desktop-large:px-[72px] desktop-large:py-[71px]">
                                            <div class="grid grid-cols-1 tablet-middle:grid-cols-2 gap-4 tablet-middle:gap-8 desktop-middle:gap-20 desktop-large:gap-[103px]">
                                                <div>
                                                    ...
                                                    <p class="text-20 font-gordita-regular text-text-primary mb-6 desktop-large:mb-8">Estamos
                                                        encantados de ofrecerles
                                                        plantillas gratuitas
                                                        descargables, como una
                                                        forma de complementar y facilitar su arduo trabajo diario.</p>
                                                    <p class="text-20 font-gordita-regular text-text-primary mb-6 desktop-large:mb-8">Sabemos lo
                                                        ...
                                                        tiempo y esfuerzo.</p>
                                                    <p class="text-20 font-gordita-regular text-text-primary mb-6 desktop-large:mb-8">Sólo debes
                                                        llenar el siguiente
                                                        ...
                                                        conocimientos.</p>
                                                    <p class="font-gordita-medium text-20 text-text-primary mb-6 desktop-large:mb-8">¡Es un placer
                                                        tenerte
                                                        como parte de
